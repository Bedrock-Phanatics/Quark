...
namespace quark\tools\compact_regions;

use quark\utils\Utils;
use quark\world\format\io\exception\CorruptedChunkException;
use quark\world\format\io\region\CorruptedRegionException;
use quark\world\format\io\region\RegionLoader;
...
if(!defined('quark\_PHPSTAN_ANALYSIS')){
	exit(main($argv ?? []));
}
