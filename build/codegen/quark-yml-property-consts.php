...
namespace quark\build\generate_quark_yml_property_consts;
...
$defaultConfig = yaml_parse(Filesystem::fileGetContents(dirname(__DIR__, 2) . '/resources/quark.yml'));

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default quark.yml\n");
	exit(1);
}
