...
/**
 * Processes modernized self-signed logins
 * TODO: Mostly duplicated code from ProcessOpenIdLoginTask. Can't generalise this in a patch release due to BC breaks
 */
